...
class TripDetailScreen extends StatelessWidget {
  ...
  Widget bulidTitle(BuildContext ctx, String titleText) {
    return Container(
  ...
  Widget bulidListViewContainer(Widget child) {
    return Container(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            bulidTitle(context, 'الانشطة'),
            bulidListViewContainer(
              ListView.builder(
            ...
            SizedBox(height: 10),
            bulidTitle(context, 'البرنامج اليومي'),
            bulidListViewContainer(
              ListView.builder(
